...
#line 4 "..\\Src\\interrupt.c"
#line 1 "../Inc/interrupt.h"



 
#line 6 "../Inc/interrupt.h"
#line 1 "../Inc/main.h"
...
#line 6 "..\\Src\\interrupt.c"
#line 7 "..\\Src\\interrupt.c"
...
void TIM2_IRQHandler(void)
{
	...
	if ((((((TIM_TypeDef *)(0x40000000U + 0x00000000U))->SR) & ((0x1U << (0U)))) != RESET)){
		((((TIM_TypeDef *)(0x40000000U + 0x00000000U))->SR) &= ~((0x1U << (0U))));
		sec++;
...
void TIM4_IRQHandler(void)
{
  ...
  if (((((TIM_TypeDef *)(0x40000000U + 0x00000800U))->SR) & ((0x1U << (4U)))) != RESET){
      
      ((((TIM_TypeDef *)(0x40000000U + 0x00000800U))->SR) &= ~((0x1U << (4U))));
      
      Value_Prev = Value;
      Value = ((TIM_TypeDef *)(0x40000000U + 0x00000800U))->CCR4;
      uint16_t duration = (Value >= Value_Prev) ? (Value - Value_Prev) :       (65535 - Value_Prev + Value);
