...
#line 84 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal.c"
...
HAL_StatusTypeDef HAL_DeInit(void)
{
  ...
  (((RCC_TypeDef *)((0x40000000U + 0x00020000U) + 0x00001000U))->APB2RSTR = 0xFFFFFFFFU);
  (((RCC_TypeDef *)((0x40000000U + 0x00020000U) + 0x00001000U))->APB1RSTR = 0x00);

  (((RCC_TypeDef *)((0x40000000U + 0x00020000U) + 0x00001000U))->APB2RSTR = 0xFFFFFFFFU);
  (((RCC_TypeDef *)((0x40000000U + 0x00020000U) + 0x00001000U))->APB2RSTR = 0x00);
...
uint32_t HAL_GetHalVersion(void)
{
 return (((0x01U) << 24) |((0x01U) << 16) |((0x01U) << 8 ) |((0x00U)));
}
...
void HAL_GetUID(uint32_t *UID)
{
  UID[0] = (uint32_t)(((*((uint32_t *)0x1FFFF7E8U))));
  UID[1] = (uint32_t)(((*((uint32_t *)(0x1FFFF7E8U + 4U)))));
  UID[2] = (uint32_t)(((*((uint32_t *)(0x1FFFF7E8U + 8U)))));
}
