...
#line 16 "..\\Hardware\\delay\\delay.c"
...
#line 17 "..\\Hardware\\delay\\delay.c"
...
void delay_init(void)
{
	...
	*(volatile unsigned long *)0xE000EDFC |= (1UL << 24U);
	*(volatile unsigned long *)0xE0001004  = 0;
	*(volatile unsigned long *)0xE0001000 |= (0x1UL ); 
}
...
void delay_us(uint32_t us)
{
      uint32_t t0 =  ((DWT_Type *) (0xE0001000UL) )->CYCCNT;
      uint32_t us_count_tic =  us * (SystemCoreClock/1000000);
      while (delta(t0, ((DWT_Type *) (0xE0001000UL) )->CYCCNT) < us_count_tic) ;
}
