...
#line 104 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_dma.c"
...
#line 196 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_dma.c"
   
  hdma->ChannelIndex = (((uint32_t)hdma->Instance - (uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000008U))) / ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x0000001CU)) - (uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000008U)))) << 2;
  hdma->DmaBaseAddress = ((DMA_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000000U));
...
#line 286 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_dma.c"
  ...
  hdma->DmaBaseAddress->IFCR = ((0x1U << (0U)) << (hdma->ChannelIndex));
...
HAL_StatusTypeDef HAL_DMA_Start_IT(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t DataLength)
{
  ...
  if(HAL_DMA_STATE_READY == hdma->State)
  {
    ...
    if(0 != hdma->XferHalfCpltCallback)
    {
      ...
      ((((hdma)->Instance ->CCR) |= (((((uint32_t)(0x1U << (1U))) | ((uint32_t)(0x1U << (2U))) | ((uint32_t)(0x1U << (3U))))))));
    }
    else
    {
      ((((hdma)->Instance ->CCR) &= ~((((uint32_t)(0x1U << (2U)))))));
      ((((hdma)->Instance ->CCR) |= (((((uint32_t)(0x1U << (1U))) | ((uint32_t)(0x1U << (3U))))))));
    }
...
{  
  ...
  { 
    ...
    (((DMA_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000000U))->IFCR = ((((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000008U))))? 0x00000001U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x0000001CU))))? 0x00000010U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000030U))))? 0x00000100U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000044U))))? 0x00001000U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000058U))))? 0x00010000U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x0000006CU))))? 0x00100000U : 0x01000000U)));
...
HAL_StatusTypeDef HAL_DMA_PollForTransfer(DMA_HandleTypeDef *hdma, uint32_t CompleteLevel, uint32_t Timeout)
{
  ...
  if (RESET != (hdma->Instance->CCR & (0x1U << (5U))))
  {
  ...
  if(CompleteLevel == HAL_DMA_FULL_TRANSFER)
  {
    ...
    temp = (((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000008U))))? 0x00000002U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x0000001CU))))? 0x00000020U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000030U))))? 0x00000200U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000044U))))? 0x00002000U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000058U))))? 0x00020000U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x0000006CU))))? 0x00200000U : 0x02000000U);
  }
  else
  {
     
    temp = (((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000008U))))? 0x00000004U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x0000001CU))))? 0x00000040U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000030U))))? 0x00000400U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000044U))))? 0x00004000U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000058U))))? 0x00040000U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x0000006CU))))? 0x00400000U : 0x04000000U);
  }

   
  tickstart = HAL_GetTick();

  while((((DMA_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000000U))->ISR & (temp)) == RESET)
  {
    if(((((DMA_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000000U))->ISR & ((((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000008U))))? 0x00000008U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x0000001CU))))? 0x00000080U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000030U))))? 0x00000800U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000044U))))? 0x00008000U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x00000058U))))? 0x00080000U : ((uint32_t)((hdma)->Instance) == ((uint32_t)((DMA_Channel_TypeDef *)((0x40000000U + 0x00020000U) + 0x0000006CU))))? 0x00800000U : 0x08000000U))) != RESET))
    {
...
void HAL_DMA_IRQHandler(DMA_HandleTypeDef *hdma)
{
  ...
  if (((flag_it & (0x00000004U << hdma->ChannelIndex)) != RESET) && ((source_it & ((uint32_t)(0x1U << (2U)))) != RESET))
  {
     
    if((hdma->Instance->CCR & (0x1U << (5U))) == 0U)
    {
  ...
  else if (((flag_it & (0x00000002U << hdma->ChannelIndex)) != RESET) && ((source_it & ((uint32_t)(0x1U << (1U)))) != RESET))
  {
    if((hdma->Instance->CCR & (0x1U << (5U))) == 0U)
    {
       
      ((((hdma)->Instance ->CCR) &= ~((((uint32_t)(0x1U << (3U))) | ((uint32_t)(0x1U << (1U)))))));  
  ...
  else if (( RESET != (flag_it & (0x00000008U << hdma->ChannelIndex))) && (RESET != (source_it & ((uint32_t)(0x1U << (3U))))))
  {
