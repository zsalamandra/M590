...
void MX_GPIO_Init(void)
{
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *)((0x40000000U + 0x00020000U) + 0x00001000U))->APB2ENR) |= ((0x1U << (5U)))); tmpreg = ((((RCC_TypeDef *)((0x40000000U + 0x00020000U) + 0x00001000U))->APB2ENR) & ((0x1U << (5U)))); ((void)(tmpreg)); } while(0U);
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x4000)|((uint16_t)0x8000)|((uint16_t)0x0008)|((uint16_t)0x0010) 
                          |((uint16_t)0x0020)|((uint16_t)0x0040)|((uint16_t)0x0080), GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x4000)|((uint16_t)0x8000)|((uint16_t)0x0008)|((uint16_t)0x0010) 
                          |((uint16_t)0x0020)|((uint16_t)0x0040)|((uint16_t)0x0080);
  GPIO_InitStruct.Mode = 0x00000001U;
  GPIO_InitStruct.Speed = ((0x2U << (0U)));
  HAL_GPIO_Init(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), &GPIO_InitStruct);

   
  GPIO_InitStruct.Pin = ((uint16_t)0x0100) | ((uint16_t)0x2000);
  GPIO_InitStruct.Mode = 0x00000001U;
  GPIO_InitStruct.Speed = ((0x2U << (0U)));
