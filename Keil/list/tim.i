...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  if(tim_baseHandle->Instance==((TIM_TypeDef *)(0x40000000U + 0x00000000U)))
  {
   

   
     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *)((0x40000000U + 0x00020000U) + 0x00001000U))->APB1ENR) |= ((0x1U << (0U)))); tmpreg = ((((RCC_TypeDef *)((0x40000000U + 0x00020000U) + 0x00001000U))->APB1ENR) & ((0x1U << (0U)))); ((void)(tmpreg)); } while(0U);
