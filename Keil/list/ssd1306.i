...
#line 91 "..\\Hardware\\SSD1306\\SSD1306.h"

#line 99 "..\\Hardware\\SSD1306\\SSD1306.h"
...
#line 23 "..\\Hardware\\SSD1306\\SSD1306.c"
#line 24 "..\\Hardware\\SSD1306\\SSD1306.c"
#line 25 "..\\Hardware\\SSD1306\\SSD1306.c"
...
#line 58 "..\\Hardware\\SSD1306\\SSD1306.c"
...
void spi_write_byte(uint8_t data){
	...
	((SPI_TypeDef *)((0x40000000U + 0x00010000U) + 0x00003000U))->DR = data;
}								
...
static void ssd1306_write_byte(uint8_t chData, uint8_t chCmd) 
{
		...
		HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0080), GPIO_PIN_RESET);
	
	if (chCmd) {
		HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0010), GPIO_PIN_SET);
	} else {
		HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0010), GPIO_PIN_RESET);
	}	
	...
	for(int i = 0; i < 8; i ++) {
		HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0008), GPIO_PIN_RESET);
		
		delay_us(10);
		
		if(chData & 0x80) {
			HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0020), GPIO_PIN_SET);
		} else {
			HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0020), GPIO_PIN_RESET);
		}
		HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0008), GPIO_PIN_SET);
		chData <<= 1;
	}
	
	HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0010), GPIO_PIN_SET);
	HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0080), GPIO_PIN_SET);
...
{
	ssd1306_write_byte(0x8D, 0);  
	ssd1306_write_byte(0x14, 0);  
	ssd1306_write_byte(0xAF, 0);  
}
...
{
	ssd1306_write_byte(0x8D, 0);  
	ssd1306_write_byte(0x10, 0); 
	ssd1306_write_byte(0xAE, 0);  
}
...
void ssd1306_refresh_gram(void)
{
	...
	for (i = 0; i < 8; i ++) {  
		ssd1306_write_byte(0xB0 + i, 0);    
		do { ssd1306_write_byte(0x02, 0); ssd1306_write_byte(0x10, 0); } while(0);      
		for (j = 0; j < 128; j ++) {
			ssd1306_write_byte(s_chDispalyBuffer[j][i], 1); 
		}
	}   
}
...
void ssd1306_draw_antenna(uint8_t chXpos, uint8_t chYpos, uint8_t level)
{
	const uint8_t c_chSingal[16] = 
{
	0x00,0x03,0x05,0x09,0xFF,0x09,0x05,0x03,0x80,0xC0,0xE0,0xF0,0xF8,0xFC,0xFE,0xFF
};
   for(int y = 0; y < 8; y++){
			for(int i=0; i < 8; i++){ 
					if (*(c_chSingal + y) & (1 << (i & 7))){
						ssd1306_draw_point(chXpos + y, chYpos + i, 1);
					}
				}
    }
		
   for(int y = 7; y < level+7; y++){
			for(int i=0; i < 8; i++){ 
					if (*(c_chSingal + y) & (1 << (i & 7))){
						ssd1306_draw_point(chXpos + y, chYpos + i, 1);
					}
...
void ssd1306_init(void)
{
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0080), GPIO_PIN_SET);   
	HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0010), GPIO_PIN_RESET);   
	HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0040), GPIO_PIN_SET);  
		...
		HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0020)|((uint16_t)0x0008), GPIO_PIN_RESET);

		 
		GPIO_InitStruct.Pin 	= ((uint16_t)0x0020)|((uint16_t)0x0008);
...
#line 528 "..\\Hardware\\SSD1306\\SSD1306.c"

	ssd1306_write_byte(0xAE, 0);
	ssd1306_write_byte(0x00, 0);
	ssd1306_write_byte(0x10, 0);
	ssd1306_write_byte(0x40, 0);
	ssd1306_write_byte(0x81, 0);
	ssd1306_write_byte(0xCF, 0);
	ssd1306_write_byte(0xA1, 0);
	ssd1306_write_byte(0xC0, 0);
	ssd1306_write_byte(0xA6, 0);
	ssd1306_write_byte(0xA8, 0);
	ssd1306_write_byte(0x3f, 0);
	ssd1306_write_byte(0xD3, 0);
	ssd1306_write_byte(0x00, 0);
	ssd1306_write_byte(0xd5, 0);
	ssd1306_write_byte(0x80, 0);
	ssd1306_write_byte(0xD9, 0);
	ssd1306_write_byte(0xF1, 0);
	ssd1306_write_byte(0xDA, 0);
	ssd1306_write_byte(0x12, 0);
	ssd1306_write_byte(0xDB, 0);
	ssd1306_write_byte(0x40, 0);
	ssd1306_write_byte(0x20, 0);
	ssd1306_write_byte(0x02, 0);
	ssd1306_write_byte(0x8D, 0);
	ssd1306_write_byte(0x14, 0);
	ssd1306_write_byte(0xA4, 0);
	ssd1306_write_byte(0xA6, 0);
	ssd1306_write_byte(0xAF, 0);
