...
#line 57 "..\\Hardware\\SSD1306\\SSD1306.c"
...
static void ssd1306_write_byte(uint8_t chData, uint8_t chCmd) 
{
		...
		GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0080), PINRES);
	
	if (chCmd) {
		GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0010), PINSET);
	} else {
		GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0010), PINRES);
	}	
	...
	for(int i = 0; i < 8; i ++) {
		GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0008), PINRES);
		
		delay_us(10);
		
		if(chData & 0x80) {
			GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0020), PINSET);
		} else {
			GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0020), PINRES);
		}
		GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0008), PINSET);
		chData <<= 1;
	}
	
	GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0010), PINSET);
	GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0080), PINSET);
...
void ssd1306_init(void)
{
	GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0080), PINSET);   
	GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0010), PINRES);   
	GPIO_WritePin(((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), ((uint16_t)0x0040), PINSET);  
