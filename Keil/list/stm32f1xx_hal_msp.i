...
#line 51 "../Src/stm32f1xx_hal_msp.c"
...
void HAL_MspInit(void)
{
  ...
  do{ ((((AFIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000000U))->MAPR) &= ~((0x7U << (24U)))); ((((AFIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000000U))->MAPR) |= ((0x1U << (26U)))); }while(0U);
