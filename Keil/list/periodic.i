...
#line 3 "..\\Src\\periodic.c"
#line 1 "../Inc/event_functions.h"



void EF_PrintOperatorName(void);
	




#line 4 "..\\Src\\periodic.c"
...
void Event_SecCallback(void){
	...
	if (sec%60 == 0){
		sec = 0;
		ES_PlaceEvent( (pxEventFuncType)EF_PrintOperatorName );
