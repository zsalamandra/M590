...
HAL_StatusTypeDef HAL_FLASHEx_Erase(FLASH_EraseInitTypeDef *pEraseInit, uint32_t *PageError)
{
  ...
  {
#line 231 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
    {
...
#line 288 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
   {
...
HAL_StatusTypeDef HAL_FLASHEx_OBErase(void)
{
  ...
  if(status == HAL_OK)
  {
    ...
    ((((FLASH_TypeDef *)((0x40000000U + 0x00020000U) + 0x00002000U))->CR) |= ((0x1U << (5U))));
...
uint32_t HAL_FLASHEx_OBGetUserData(uint32_t DATAAdress)
{
  ...
  if (DATAAdress == 0x1FFFF804U)
  {
    ...
    value = ((((FLASH_TypeDef *)((0x40000000U + 0x00020000U) + 0x00002000U))->OBR) & ((0xFFU << (10U)))) >> (10U);
  }
  else
  {
     
    value = ((((FLASH_TypeDef *)((0x40000000U + 0x00020000U) + 0x00002000U))->OBR) & ((0xFFU << (18U)))) >> (18U);
  }
...
#line 640 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
...
#line 710 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
  ...
  { 
    ...
    if (status == HAL_OK)  
    {
      ...
      ((((FLASH_TypeDef *)((0x40000000U + 0x00020000U) + 0x00002000U))->CR) |= ((0x1U << (4U))));


      if(WRP0_Data != 0xFFU)
      {
        ((OB_TypeDef *)0x1FFFF800U)->WRP0 &= WRP0_Data;
      ...
      {
        ((OB_TypeDef *)0x1FFFF800U)->WRP1 &= WRP1_Data;
      ...
      {
        ((OB_TypeDef *)0x1FFFF800U)->WRP2 &= WRP2_Data;
      ...
      {
        ((OB_TypeDef *)0x1FFFF800U)->WRP3 &= WRP3_Data;
...
static HAL_StatusTypeDef FLASH_OB_DisableWRP(uint32_t WriteProtectPage)
{
  ...
  WRP3_Data = (uint16_t)((WriteProtectPage & 0xFF000000U) >> 24U); 
#line 833 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
...
static HAL_StatusTypeDef FLASH_OB_RDP_LevelConfig(uint8_t ReadProtectLevel)
{
  ...
  { 
    ...
    if(status == HAL_OK)
    {
      ...
      ((((OB_TypeDef *)0x1FFFF800U)->RDP) = (ReadProtectLevel));
...
static HAL_StatusTypeDef FLASH_OB_UserConfig(uint8_t UserConfig)
{
  ...
  {     
    ...
    ((OB_TypeDef *)0x1FFFF800U)->USER = (UserConfig | 0x88U);
...
static uint32_t FLASH_OB_GetWRP(void)
{
  ...
  return (uint32_t)(((((FLASH_TypeDef *)((0x40000000U + 0x00020000U) + 0x00002000U))->WRPR)));
}
...
static uint32_t FLASH_OB_GetRDP(void)
{
  ...
  tmp_reg = ((((FLASH_TypeDef *)((0x40000000U + 0x00020000U) + 0x00002000U))->OBR) & ((0x1U << (1U))));
...
static uint8_t FLASH_OB_GetUser(void)
{
  ...
  return (uint8_t)((((((FLASH_TypeDef *)((0x40000000U + 0x00020000U) + 0x00002000U))->OBR)) & (0x7U << (2U))) >> (2U));
}
...
#line 1123 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
     
    ((((FLASH_TypeDef *)((0x40000000U + 0x00020000U) + 0x00002000U))->CR) |= ((0x1U << (1U))));
    ((((FLASH_TypeDef *)((0x40000000U + 0x00020000U) + 0x00002000U))->AR) = (PageAddress));
    ((((FLASH_TypeDef *)((0x40000000U + 0x00020000U) + 0x00002000U))->CR) |= ((0x1U << (6U))));
