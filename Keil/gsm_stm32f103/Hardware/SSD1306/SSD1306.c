...
#if !(defined(HARDWARE_PROTOCOL) ^ defined(SOFTWARE_PROTOCOL))
	#warning Please select first the protocol type(HARDWARE_PROTOCOL or SOFTWARE_PROTOCOL) in your application!
	#define SOFTWARE_PROTOCOL  //define SSD1306 by default	
#endif	
...
{
	const uint8_t c_chSingal[16] = //mobie singal
{
